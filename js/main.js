...
(function ($) {
        ...
        if (typeof $.fn.mCustomScrollbar === 'function') {
            if ($('.navbar-collapse-clone').length) {
                ...
                if (typeof (scrollOptions) !== 'undefined' && scrollOptions !== null) {
                    try {
                        scrollOptions = JSON.parse(scrollOptions);
                    } catch (e) {
                        try {
                            scrollOptions = (new Function('return ' + scrollOptions))();
                        } catch (e2) {
                            scrollOptions = {};
                        }
                    }
            ...
            $('.justified-gallery').each(function () {
                ...
                if (typeof $.fn.justifiedGallery !== 'undefined') {
                    if (typeof (justifiedOptions) !== 'undefined' && justifiedOptions !== null) {
                        _this.imagesLoaded(function () {
                            try {
                                justifiedOptions = JSON.parse(justifiedOptions);
                            } catch (e) {
                                try {
                                    justifiedOptions = (new Function('return ' + justifiedOptions))();
                                } catch (e2) {
                                    justifiedOptions = {};
                                }
                            }
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (typeof (slider) !== 'undefined' && slider !== null) {
                    ...
                    var sliderOptions;
                    try {
                        sliderOptions = JSON.parse(slider);
                    } catch (e) {
                        try {
                            sliderOptions = (new Function('return ' + slider))();
                        } catch (e2) {
                            sliderOptions = {};
                        }
                    }
    ...
    function setupSwiper() {
        ...
        swipers.forEach(function (swiperItem) {
            ...
            if (typeof (sliderOptions) !== 'undefined' && sliderOptions !== null) {
                ...
                // Try parsing as strict JSON first; if it fails (common when attributes
                // provide JS object literals like {slidesPerView:3}), fall back to
                // evaluating the string as a JS expression in a safe function scope.
                try {
                    sliderOptions = JSON.parse(sliderOptions);
                } catch (e) {
                    try {
                        sliderOptions = (new Function('return ' + sliderOptions))();
                    } catch (e2) {
                        sliderOptions = {};
                    }
                }
                ...
                if (dataThumbs != '' && dataThumbs != undefined && sliderOptions['pagination'] != '' && sliderOptions['pagination'] != undefined) {
                    try {
                        dataThumbs = JSON.parse(dataThumbs);
                    } catch (e) {
                        try {
                            dataThumbs = (new Function('return ' + dataThumbs))();
                        } catch (e2) {
                            dataThumbs = null;
                        }
                    }
                                ...
                                fancy_el.forEach(element => {
                                    ...
                                    if (typeof (fancy_options) !== 'undefined' && fancy_options !== null) {
                                        try {
                                            ...
                                            try {
                                                fancy_options = (new Function('return ' + fancy_options))();
                                            } catch (e2) {
                                                fancy_options = {};
                                            }
                                        }
    ...
    var themeDemoHTML = '<div class="theme-demos"><div class="demo-button-wrapper"><div class="buy-theme"><a href="facebook.com" target="_blank"><div class="theme-wrapper"><div><svg xmlns="#" width="20" height="20" viewbox="0 0 22.284 25.436"><path d="M19.314,9.285c-.745-.414-2.882-.158-5.449.637-4.492,3.07-8.283,7.594-8.547,14.858-.048.174-.491-.024-.579-.077a10.346,10.346,0,0,1-.681-8.3c.189-.314-.428-.7-.539-.591a12.683,12.683,0,0,0-1.765,2.278,11.061,11.061,0,0,0,19.33,10.759c3.438-6.161.246-18.432-1.77-19.558Z" transform="translate(-0.32 -9.089)" fill="#fff"></path></svg></div></div></a></div><div class="all-demo"><a href="#"><div class="theme-wrapper"><div>Visit US</div></div></a></div></div><span class="close-popup fs-22 text-dark-gray w-40px h-40px d-flex justify-content-center align-items-center"><i class="fa-solid fa-xmark"></i></span></div>';
...
function initMap() {
    $('.map').each(function (e) {
        ...
        // Convert String into the Json (try strict JSON, fall back to JS literal)
        if (typeof (mapOptions) !== 'undefined' && mapOptions !== null) {
            try {
                mapOptions = JSON.parse(mapOptions);
            } catch (e) {
                try {
                    mapOptions = (new Function('return ' + mapOptions))();
                } catch (e2) {
                    mapOptions = {};
                }
            }
